...
void BoldoledPutString(unsigned char *ptr,unsigned char page, unsigned char col,...)
{
	va_list ap;
	int count;
	int wordcount = 1;
...
ROM BYTE g_pucFont[105][50] =
{
    ...
    { 0x04, 0x02, 0x1F, 0x02, 0x04 }, // ARROW   0X7A
    { 0x00, 0x08, 0x36, 0x41, 0x00 }, // {   0X7B
    { 0x00, 0x00, 0x7f, 0x00, 0x00 }, // |   0X7C
    { 0x00, 0x41, 0x36, 0x08, 0x00 }, // }   0X7D
    { 0x11, 0x08, 0x1e, 0x1f, 0x1f }, // ~   0X7E
	{ 0x00, 0x0C, 0x12, 0x12, 0x0C }, // Degrees   0X7F
	{ 0x00, 0xFF, 0xFF, 0xFF, 0x00 }, // |   0X80
	{ 0x3C, 0x3C, 0x3C, 0x3C, 0x3C }, // slider_point   0X81
	{ 0x08, 0x08, 0x08, 0x08, 0x08 }, // slider_line   0X82
	{ 0x11, 0x0A, 0x04, 0x0A, 0x11 }, // X   0X83
	{ 0x08, 0x10, 0x08, 0x04,0x02 }, // V   0X84
	{ 0x04, 0x04, 0x15, 0x0E, 0x04 }, // ->   0X85
	{ 0x0E, 0x08, 0x08, 0x08, 0x0E, }, // <-   0X86
