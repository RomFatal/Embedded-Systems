...
void oledRepeatString(unsigned char *ptr, unsigned int i,unsigned char page, unsigned char col)
{
int count;
	for(count = 0; count < i; count++)
{
	oledPutString(ptr, page, col+count);
}
}
...
//////////////////////////////////////
//////////////////////////////////////
ROM BYTE g_pucFont[103][5] =
{
    { 0x00, 0x00, 0x00, 0x00, 0x00 }, // " " 0x20
    { 0x00, 0x00, 0x4f, 0x00, 0x00 }, // !   0x21
    { 0x00, 0x07, 0x00, 0x07, 0x00 }, // "   0x22
    { 0x06, 0x09, 0x09, 0x06, 0x00 }, // #   0x23
